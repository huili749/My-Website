    ...
    <div className="about-container">
      ...
      <div className="intro-container">
        ...
        <p className="intro-paragraph">
          ...
          With a strong foundation in programming languages like Python, JavaScript, and R, I excel at leveraging computational tools and frameworks, such as PyTorch, TensorFlow, and React, to explore innovative solutions in various field. 
        ...
        <p className="intro-paragraph">
          I am deeply interested in technical problem-solving and computational design, leveraging my computational expertise to develop innovative solutions. 
